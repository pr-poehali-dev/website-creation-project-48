  ...
  const rulesCategories = [
    {
      ...
      link: "/rules/general",
      rules: [
        "Регистрируясь, вы соглашаетесь со всеми правилами",
        "Незнание правил не освобождает от ответственности",
        "Администрация может изменять правила без уведомления",
        "Окончательное решение остается за администрацией",
        "Все правила основаны на здравом смысле"
      ]
    },
    {
      title: "Правила РП",
    ...
    },
    {
      ...
      rules: [
        "Запрещены оскорбления и переход на личности",
        "Обход мута/бана строго наказывается",
        "Запрещен спам, флуд и капс в чате",
        "Реклама сторонних ресурсов запрещена",
        "Угрозы в сторону игроков недопустимы"
      ]
    },
    {
